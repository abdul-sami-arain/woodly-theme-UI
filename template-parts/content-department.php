...
<div class="col-lg-4 woodly-team-block-d">
    
     <div class="text-center woodly-expert-doctors-position ex-doctor-style-one">
                                                            <div class="woodly-expert-doctors-1st m-lg-2 m-2 text-center woodly-bg-style">
                                                                <h2 class="woodly-global-h-md medical-treatment-name-h2 "><a href="<?php the_permalink(); ?>"><?php the_title(); ?>
                                                                    </a></h2>
