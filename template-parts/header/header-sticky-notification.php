<?php
$woodly_options = get_option( 'woodly_options' );
$sticky_header_content = $woodly_options['sticky_header_content'];
$sticky_btn_text = $woodly_options['sticky_button_text'];
$sticky_btn_url = $woodly_options['sticky_button_url'];
$ntbgtype =  $woodly_options['sticky_bar_style'];
$notification_btn_target =  $woodly_options['button_target'];
