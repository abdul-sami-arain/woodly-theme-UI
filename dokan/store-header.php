...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'woodly' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'woodly' );
...
<section class="container woodly-extended-container woodly-dokan-custom-header">
            
            <?php if ( $store_user->get_banner() ) { ?>
    <div class="woodly-common-breadcrumbs woodly-dokan-sotre-header" style="background:url( <?php echo esc_url( $store_user->get_banner() ); ?>);">
        <?php } else { ?>
        <div class="woodly-common-breadcrumbs ">
        <?php } ?>
