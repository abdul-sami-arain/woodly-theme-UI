...
(function ($, window, document, undefined) {
    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                '<span class="woodly-count-item"><span class="emerce-count-value item item-dd">',
                    '<span class="dd"></span>',
                    '<span class="label label-dd">', this.options.label_dd, '</span>',
                '</span></span>',
                '<span class="separator separator-dd">', this.options.separator, '</span>',
                '<span class="woodly-count-item"><span class="emerce-count-value item item-hh">',
                    '<span class="hh-1"></span>',
                    '<span class="hh-2"></span>',
                    '<span class="label label-hh">', this.options.label_hh, '</span>',
                '</span> </span>',
                '<span class="separator">', this.options.separator, '</span>',
                '<span class="woodly-count-item"><span class="emerce-count-value item item-mm">',
                    '<span class="mm-1"></span>',
                    '<span class="mm-2"></span>',
                    '<span class="label label-mm">', this.options.label_mm, '</span>',
                '</span></span>',
                '<span class="separator">', this.options.separator, '</span>',
                '<span class="woodly-count-item"><span class="emerce-count-value item item-ss">',
                    '<span class="ss-1"></span>',
                    '<span class="ss-2"></span>',
