...
function mayosis_merlin_import_file_urls() {
 ...
 array(
            ...
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-one/site-content.xml',
            ...
            'local_import_csf' => array(
                array(
                    ...
                    'option_name' => 'woodly_options',
                ),
            ),
            'import_preview_image_url' => WOODLY_URL .'/assets/images/demos/1.png',
            'preview_url' => 'https://teconce.com/woodly-maindemo/',
            'import_notice' => __
           ...
           array(
            ...
            'categories' => array('Elementor'),
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-two/site-content.xml',
            
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-two/widgets.wie',
            'local_import_csf' => array(
                array(
            ...
            'import_preview_image_url' => WOODLY_URL .'/assets/images/demos/2.jpg',
            'preview_url' => 'https://teconce.com/woodly-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
         ...
         array(
            ...
            'categories' => array('Elementor'),
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-three/site-content.xml',
            
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-three/widgets.wie',
            'local_import_csf' => array(
                array(
            ...
            'import_preview_image_url' => WOODLY_URL .'/assets/images/demos/3.jpg',
            'preview_url' => 'https://teconce.com/woodly-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
         ...
         array(
            ...
            'categories' => array('Elementor'),
            'local_import_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-four/site-content.xml',
            
            'local_import_widget_file' => trailingslashit(get_template_directory()) . 'inc/admin/import/home-four/widgets.wie',
            'local_import_csf' => array(
                array(
            ...
            'import_preview_image_url' => WOODLY_URL .'/assets/images/demos/4.jpg',
            'preview_url' => 'https://teconce.com/woodly-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
