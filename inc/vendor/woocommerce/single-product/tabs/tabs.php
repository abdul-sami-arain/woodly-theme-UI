...
$productglobalmeta = get_post_meta ( get_the_ID(), 'single_style_m', true );

if ($productglobalmeta == true ){
    $tabstyle  = get_post_meta ( get_the_ID(), 'single_product_desc_style', true );
    
} else {
$tabstyle = cs_get_option('single_product_desc_style_main');
}
...
<div class="accordion woodly-p-accordion" id="xoopidescaccordion">
      	...
      	<?php if ($key == 'description'){
      	  ...
      	  <div class="accordion-item woodly-p-accordion-items">
...
<?php } elseif ($tabstyle=='style-two') { ?>

<!-- Tab panes -->
<div class="woodly_block_content_woo_single row gx-0">
    <div class="col-12 col-md-6 woodly_block_left_content_woos">
        
        
        
        	<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
        	<?php if ($key == 'description'){ ?>
        	<div class="woodly-wooblock-contents">
        	<h4 class="woodly-style2-title-md"><?php echo wp_kses_post( apply_filters( 'woocommerce_product_' . $key . '_tab_title', $product_tab['title'], $key ) ); ?></h4>
        	...
        	<?php if ($key == 'additional_information'){ ?>
        		...
        		<div class="woodly-wooblock-additional-info">
        	        <h4 class="woodly-style2-title-md"><?php echo wp_kses_post( apply_filters( 'woocommerce_product_' . $key . '_tab_title', $product_tab['title'], $key ) ); ?></h4>
        	   <?php if ( isset( $product_tab['callback'] ) ) {
					call_user_func( $product_tab['callback'], $key, $product_tab );
				} ?>
    ...
    <div class="col-12 col-md-6 woodly_block_right_content_woos">
        
        	<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
        	<?php if ($key == 'reviews'){ ?>
        		<div class="woodly-wooblock-reviewd">
        	<h4 class="woodly-style2-title-md"><?php echo wp_kses_post( apply_filters( 'woocommerce_product_' . $key . '_tab_title', $product_tab['title'], $key ) ); ?></h4>
        	   <?php  if ( isset( $product_tab['callback'] ) ) {
					call_user_func( $product_tab['callback'], $key, $product_tab );
				} ?>
