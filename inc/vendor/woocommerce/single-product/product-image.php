...
if($gallerytoption == 'gridtwo'){
  wc_get_template_part( 'single-product/product-image', 'grid-two' );
  return;
}

if($gallerytoption == 'carousel'){
  wc_get_template_part( 'single-product/product-image', 'carousel' );
  return;
}
