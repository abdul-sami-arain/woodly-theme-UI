...
<div class="woodly_home_two_product-content">
    <div class="card h-100 border-0">
        <div class="woodly__home_two-carousel-img">
        ...
        <div class="woodly__home_two-carousel-content">
            ...
            <div class="woodly__home_two-carousel-rating">
                ...
                <div class="woodly__home_two-rating-count">
                    <?php
        ...
        <div class="woodly__home_two-carousel-cart-btn">
